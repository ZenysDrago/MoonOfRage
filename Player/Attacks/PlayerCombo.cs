...
public class PlayerCombo : MonoBehaviour
{
    ...
    [SerializeField] private GameObject hitBoxSlam;
    ...
    public IEnumerator SlamCombo(float recallTime)
    {
        ...
        Instantiate(hitBoxSlam, ((p.impactMoonOnSlam.transform.position - pointAbovePlayer.transform.position)/2  + pointAbovePlayer.transform.position), Quaternion.identity);
